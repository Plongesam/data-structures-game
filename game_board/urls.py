...
urlpatterns = [
    ...
    path('llist_api/dig_tunnel/<str:id>/<str:origin>/<str:destination>', llist_api.dig_tunnel, name='llist-game-board-dig_tunnel'),
    path('llist_api/dig_chamber/<str:id>/<str:origin>/<str:move_ant>', llist_api.dig_chamber, name='llist-game-board-dig_chamber'),
    path('llist_api/fill_chamber/<str:id>/<str:origin>/<str:to_fill>', llist_api.fill_chamber, name='llist-game-board-fill_chamber'),
    path('llist_api/spawn_ant/<str:id>', llist_api.spawn_ant, name='llist-game-board-spawn_ant'),
    path('llist_api/forage/<str:id>/<str:difficulty>/<str:dest>', llist_api.forage, name='llist-game-board-forage'),
]
